...
def dydt(t,y,params):
    ...
    dER2dt = kSC*cyto - kRyr*ER2
    
    return [dcytodt,dER2dt]
...
'kcomp': [1.3040810567497516, 0.7169019119117946, 1.5990092884271527, 1.5579059658090963,0.4797353675370818, 0.4344030655861066, 0.5193421376470359, 0.5553438910956742,3.6285471437356334, 3.627562953376599, 3.518230375010903, 2.9267450550913954], 
        ...
        hypers_mu={
    'sim':{'mu_kSC': 2.0, 'mu_kRyr': 2.0e-2,},
    'expt':{'mu_kSC': 3.0, 'mu_kRyr': 2.0e-2}},

        hypers_sigma={
    'sim':{'mu_kSC': 1.0e-1, 'mu_kRyr': 1.0e-1},
    'expt':{'mu_kSC': 1.0e-1, 'mu_kRyr': 1.0e-1}},

        hyperParams=['mu_kSC','mu_kRyr'],

        params=['kSC','kRyr'],

        paramList=['w','mu_kSC','mu_kRyr','sigma_kSC','sigma_kRyr'],

        hyperLabels=['$\mu_{k_{SERCA}}$', '$\mu_{k_{Ryr}}$'],
        
        sigmaLabels=['$\sigma_{k_{SERCA}}$', '$\sigma_{k_{Ryr}}$'],

        labels=['k$_{SERCA}$', 'k$_{Ryr}$'],
