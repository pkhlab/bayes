...
def dydt(t,y,params):
    ...
    dER1dt = Vmserca/(1+(Kdserca/cyto)**2) - kcomp*ER1
...
'kcomp': [1.3040810567497516, 0.7169019119117946, 1.5990092884271527, 1.5579059658090963,0.4797353675370818, 0.4344030655861066, 0.5193421376470359, 0.5553438910956742,3.6285471437356334, 3.627562953376599, 3.518230375010903, 2.9267450550913954], 
    ...
    'expt':{'mu_Vmserca': 1.0e-1, 'mu_Kdserca':1.0e-1, 'mu_kRyr': 1.0e-1, 'mu_kcomp': 1.0e-1}},
        ...
        hyperLabels=['$\mu_{V_{max,SERCA}}$', '$\mu_{K_{d,SERCA}}$', '$\mu_{k_{Ryr}}$', '$\mu_{k_{shuttle}}$'],
        
        sigmaLabels=['$\sigma_{V_{max,SERCA}}$', '$\sigma_{K_{d,SERCA}}$', '$\sigma_{k_{Ryr}}$', '$\sigma_{k_{shuttle}}$'],
