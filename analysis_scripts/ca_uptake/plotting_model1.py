...
def loadData(
    ...
    infData['sim']=[]
    infData['expt']=[]
    #file=infDataPath+'/sim/hier/k{}/model{}/v2/v2/results.csv'.format(K,model)
...
for k in Ks:
    ...
    run(
        ...
        hypers_mu={
            'sim':{'mu_Kdatp': 3.0e-1, 'mu_r': 3.0e-1, 'mu_v': 3.0e-1, 'mu_g': 1.0e-1, 'mu_kleak': 3.0e-1},
            'expt':{'mu_Kdatp': 5.0e-1, 'mu_r': 4.0e-2, 'mu_v': 5.0e-1, 'mu_g': 5.0e-2, 'mu_kleak': 3.0e-1}},

        hypers_sigma={
            'sim':{'mu_Kdatp': 1.0e-1, 'mu_r': 1.0e-1, 'mu_v': 1.0e-1, 'mu_g': 1.0e-1, 'mu_kleak': 1.0e-1},
            'expt':{'mu_Kdatp': 1.0e-1, 'mu_r': 1.0e-1, 'mu_v': 1.0e-1, 'mu_g': 1.0e-1, 'mu_kleak': 1.0e-1}},

        hyperParams=['mu_Kdatp','mu_r','mu_v','mu_g','mu_kleak'],

        params=['Kdatp','r','v','g','kleak'],

        paramList=['w','mu_Kdatp','mu_r','mu_v','mu_g','mu_kleak','sigma_Kdatp','sigma_r','sigma_v','sigma_g','sigma_kleak'],

        hyperLabels=['$\mu_{K_{d,ATP}}$', '$\mu_{k_{decay}}$', '$\mu_{k_{close}}$', '$\mu_{k_{flux}}$', '$\mu_{k_{leak}}$'],
        
        sigmaLabels=['$\sigma_{K_{d,ATP}}$', '$\sigma_{k_{decay}}$', '$\sigma_{k_{close}}$', '$\sigma_{k_{flux}}$', '$\sigma_{k_{leak}}$'],
