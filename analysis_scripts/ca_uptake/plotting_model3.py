...
def dydt(t,y,params):
    ...
    # ode
    dATPdt = -r*ATP
    dopdt = Vmatp/(1+Kdatp/ATP)-Vmop/(1+Kdop/op)
...
for k in Ks:
    ...
    run(
        ...
        hypers_mu={
    'sim':{'mu_Kdatp': 3.0e-1, 'mu_r': 3.0e-1, 'mu_g': 1.0e-1, 'mu_kleak': 3.0e-1,'mu_Vmatp': 7.0e-1,'mu_Kdop': 2.0e-1,'mu_Vmop': 3.0e-1},
    'expt':{'mu_Kdatp': 5.0e-1, 'mu_r': 4.0e-2, 'mu_g': 5.0e-2, 'mu_kleak': 3.0e-1,'mu_Vmatp': 7.0e-1,'mu_Kdop': 2.0e-1,'mu_Vmop': 6.0e-1}},

        hypers_sigma={
    'sim':{'mu_Kdatp': 1.0e-1, 'mu_r': 1.0e-1, 'mu_g': 1.0e-1, 'mu_kleak': 1.0e-1,'mu_Vmatp': 1.0e-1,'mu_Kdop': 1.0e-1,'mu_Vmop': 1.0e-1},
    'expt':{'mu_Kdatp': 1.0e-1, 'mu_r': 1.0e-1, 'mu_g': 1.0e-1, 'mu_kleak': 1.0e-1,'mu_Vmatp': 1.0e-1,'mu_Kdop': 1.0e-1,'mu_Vmop': 1.0e-1}},

        hyperParams=['mu_Kdatp','mu_r','mu_g','mu_kleak','mu_Vmatp','mu_Kdop','mu_Vmop'],

        params=['Kdatp','r','g','kleak','Vmatp','Kdop','Vmop'],

        paramList=['w','mu_Kdatp','mu_r','mu_g','mu_kleak','mu_Vmatp','mu_Kdop','mu_Vmop','sigma_Kdatp','sigma_r','sigma_g','sigma_kleak','sigma_Vmatp','sigma_Kdop','sigma_Vmop'],
        
        hyperLabels=['$\mu_{K_{d,ATP}}$', '$\mu_{k_{decay}}$', '$\mu_{k_{flux}}$', '$\mu_{k_{leak}}$','$\mu_{V_{max,open}}$','$\mu_{K_{d,open}}$','$\mu_{V_{max,close}}$'],
        
        sigmaLabels=['$\sigma_{K_{d,ATP}}$', '$\sigma_{k_{decay}}$', '$\sigma_{k_{flux}}$', '$\sigma_{k_{leak}}$','$\sigma_{V_{max,open}}$','$\sigma_{K_{d,open}}$','$\sigma_{V_{max,close}}$'],
        
        labels=['K$_{d,ATP}$', 'k$_{decay}$', 'k$_{flux}$', 'k$_{leak}$','V$_{max,open}$','K$_{d,open}$','V$_{max,close}$'],
