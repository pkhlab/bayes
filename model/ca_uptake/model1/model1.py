...
class model():
    ...
    def dydt(self,t,y,params):
        ...
        dopdt = 1 / (1 + params.Kdatp / y.atp) - params.kclose * y.op
    ...
    def pymc(
        ...
        with pm.Model() as pm_model:    
            ...
            mu_kclose = pm.Lognormal('mu_kclose', mu=pm.math.log(hyper_mu['kclose']), sigma=hyper_sigma['kclose'], shape=K)
            ...
            sigma_kclose = pm.HalfNormal('sigma_kclose', sigma=1e-1, shape=K)
            ...
            kclose_lognormal_dist= pm.Lognormal.dist(mu=pm.math.log(mu_kclose), sigma=sigma_kclose, shape=K)
            ...
            kclose = pm.Mixture('kclose', w=w, comp_dists=kclose_lognormal_dist, shape=nCells)
